...
## Deployment
1. Step 1 - Clone the repository Serverless-ci on your localhost.
2. Step 2 - Create a branch with name as ticket number & short description 
3. Step 3 - Add a new json file at infra/env-vars/strategy-offer.json (Please note this file is case-sensitive & will be used in terraform commands for parameter injection. Any existing json file for one of the other existing instance can be used with modified values.
4. Step 4 - Create a pull request & get it reviewed by someone from DevOps team
5. Step 5 - Once the pull request is approved, you can create the new jenkins instance from the roof directory of the cloned project by running commands as mentioned below -
- Build common resources like EFS, ALB using - <br>
<i>make component-build env=”strategy-offer” component=”common”</i>
- Build Jenkins main controller using - <br>
       <i>make component-build env=”strategy-offer” component=”platform”</i>
   <br><br><br>
- Please note - These commands should always be run in the given sequence
